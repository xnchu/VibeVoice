...
*   If the voice prompt you use contains background music, the generated speech is more likely to have it as well. (The 1.5B model is quite stable and effective at this—give it a try on the demo!)
...
*   In other scenarios, the 1.5B model is more stable and has a lower probability of generating unexpected background music.
